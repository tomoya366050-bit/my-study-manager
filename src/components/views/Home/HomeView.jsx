...
const HomeView = ({ logs, categories, dailyGoalMin, onSaveGoal, ACCENT_RED }) => {
  ...
  // ★修正：円グラフのデータを「今週のログ(currentWeekLogs)」から計算するように変更
    ...
    <div key="home">
      ...
      <div style={{ display: 'flex', gap: '12px', marginBottom: '15px' }}>
        ...
        <ChicCard style={{ flex: 1, height: '260px', display: 'flex', flexDirection: 'column', alignItems: 'center' }} padding="15px">
          <ChicTypography variant="caption" style={{ marginBottom: '5px', alignSelf: 'flex-start' }}>今週の比率</ChicTypography>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '20px' }}>
        <ChicCard padding="15px" style={{ textAlign: 'center', backgroundColor: '#0a0a0a' }}>
          <ChicTypography variant="caption" style={{ color: '#888', display: 'block', marginBottom: '5px' }}>今週の平均/日</ChicTypography>
          <div style={{ fontSize: '22px', fontWeight: 'bold' }}>
            {Math.floor(weeklyAvgMin / 60)}<span style={{ fontSize: '12px', margin: '0 2px', fontWeight: 'normal', color: '#666' }}>h</span>
            {weeklyAvgMin % 60}<span style={{ fontSize: '12px', marginLeft: '2px', fontWeight: 'normal', color: '#666' }}>m</span>
          </div>
        </ChicCard>
        
        <ChicCard padding="15px" style={{ textAlign: 'center', backgroundColor: '#0a0a0a' }}>
          <ChicTypography variant="caption" style={{ color: '#888', display: 'block', marginBottom: '5px' }}>現在の継続日数</ChicTypography>
          <div style={{ fontSize: '22px', fontWeight: 'bold' }}>
            {currentStreak}<span style={{ fontSize: '12px', marginLeft: '4px', fontWeight: 'normal', color: '#666' }}>日連続</span>
          </div>
        </ChicCard>
      </div>
